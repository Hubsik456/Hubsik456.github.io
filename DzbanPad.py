...
#! Variables
    # About
DzbanPad_Version = "1.57"
Date_Creation = "10.05.2022" # d-m-y
Date_LastUpdate = "04.11.2022"  # d-m-y
    # Int
...
Settings = {
    ...
    #* General
    "General_Show_If_Is_In_Use": True,
}
Settings_Copy = {}
...
def Open_Note_In_New_Window(File_Name, File_Path):
    ...
    #! Checking If File Exists (If File Didnt mysteriously dissapear after listing all .txt files)
...
def Check_For_Notes_v2():
    ...
    if (File_Counter >= 1):
        ...
        # TODO:
        #for x in range(len(Tree.get_children())):
        #    Tree.tag_bind(x, "<Motion>", Tree_Highlight_Row)
        #    print(x)
...
if __name__ == "__main__":
    #print(Settings["General_Show_If_Is_In_Use"])
    #* Settings
    ...
    #File_Menu.add_command(label="WIP|", command=DEBUG_ListOfOpenedNotes)
        #? Config
    ...
    #Separator = GUI_2.Separator(Frame_Title, orient="horizontal")
